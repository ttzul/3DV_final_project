# 3DV Final Project - Group10

## 3D Gaussian Splatting for Real-Time Radiance Field Rendering

### Colab(Generate Point Cloud)
...
```
If you want to run 3DGS with isotrpic
```shell
python train.py -s <path to COLMAP or NeRF Synthetic dataset> --isotrpic
```
